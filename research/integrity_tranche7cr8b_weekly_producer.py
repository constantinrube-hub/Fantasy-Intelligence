...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.mode == "target":
        assert target["lifecycle"] == "preflight_active"
    ...
    print(f"PASS R8B {args.mode}: frozen v2 producer remains research-only with exact replay and typed decision blockers")
    return 0
