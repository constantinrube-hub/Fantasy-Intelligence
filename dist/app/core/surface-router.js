...
(function(){'use strict';
const known=['mainArea','modelPanel','teamPanel','tradePanel','draftAssistantPanel','draftAnalysisPanel','leagueIntelPanel','validationPanel','featuresPanel','homePanel','dstPanel','kickerPanel','valueFinderPanel','leagueRulesPanel','labOverviewPanel','researchPanel','research2Panel','research3Panel','research4Panel','research5Panel','research6Panel','matchupSimPanel'];
