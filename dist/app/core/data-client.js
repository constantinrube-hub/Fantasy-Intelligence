/* FIE centralized fetch/request layer, V9.3.2.
...
function persistentRequest(kind,url){const origin=window.location?.origin||'https://fie.local',abs=absolute(url);return new Request(`${origin}/__fie_cache__/v932/${kind}/${fnv(abs)}`,{method:'GET'});}
...
const Client={
  version:'9.3.2-data-client',defaultTimeoutMs:12000,scopeSignal:null,
