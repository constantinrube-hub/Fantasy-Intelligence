...
function vfBuildRows(){
  ...
  // Value Finder may build a discovery score, but it must never redefine Position Rank.
  ...
  // the canonical full-pool League Rank.
