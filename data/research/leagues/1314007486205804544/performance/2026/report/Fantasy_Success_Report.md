...
| TE | Validated preseason model | 123 | 78 | 73.1 | 73.1 | 0.00 | 0.913 | 5.1 | 45.5 | 43.9% | 63 |
...
| Trey McBride | 282.9 | 282.5 | -0.4 | -0.1% | 2 | 1 | 1 | 305.2 | 253.2 | 282.4 | 312.5 | Validated preseason model | FIE diagnostic is lower; main model signals: recent target share, prior-season fantasy production, prior receiving-yard production. |
| Colston Loveland | 257.4 | 152.2 | -105.2 | -40.9% | 3 | 19 | -16 | 174.9 | 124.3 | 152.1 | 180.6 | Validated preseason model | FIE diagnostic is lower; main model signals: recent target share, prior receiving-yard production, prior-season fantasy production. |
| Tyler Warren | 242.6 | 197.0 | -45.6 | -18.8% | 4 | 7 | -3 | 219.7 | 168.4 | 196.9 | 225.5 | Validated preseason model | FIE diagnostic is lower; main model signals: recent target share, prior-season fantasy production, prior receiving-yard production. |
| Sam LaPorta | 234.5 | 188.2 | -46.3 | -19.8% | 5 | 9 | -4 | 210.9 | 159.7 | 187.9 | 216.8 | Validated preseason model | FIE diagnostic is lower; main model signals: recent target share, prior receiving-yard production, prior-season fantasy production. |
...
| Kyle Pitts | 204.6 | 225.1 | 20.5 | +10.0% | 7 | 3 | 4 | 247.8 | 196.0 | 224.9 | 254.2 | Validated preseason model | FIE diagnostic is higher; main model signals: recent target share, prior-season fantasy production, prior receiving-yard production. |
...
| George Kittle | 200.3 | 232.0 | 31.7 | +15.8% | 9 | 2 | 7 | 254.7 | 203.0 | 231.7 | 260.8 | Validated preseason model | FIE diagnostic is higher; main model signals: recent target share, prior-season fantasy production, prior receiving-yard production. |
| Dalton Kincaid | 196.6 | 129.6 | -67.0 | -34.1% | 10 | 28 | -18 | 152.3 | 102.4 | 129.1 | 157.1 | Validated preseason model | FIE diagnostic is lower; main model signals: prior receiving-yard production, prior-season fantasy production, prior reception volume. |
| Travis Kelce | 206.4 | 182.7 | -23.7 | -11.5% | 11 | 11 | 0 | 205.4 | 154.2 | 182.2 | 211.2 | Validated preseason model | FIE diagnostic is lower; main model signals: recent target share, prior-season fantasy production, prior receiving-yard production. |
...
| Dallas Goedert | 162.5 | 174.2 | 11.7 | +7.2% | 14 | 14 | 0 | 196.9 | 146.2 | 174.1 | 202.5 | Validated preseason model | FIE diagnostic is higher; main model signals: recent target share, prior-season fantasy production, recent role-change signal. |
...
| Oronde Gadsden II | 169.8 | 150.7 | -19.1 | -11.2% | 16 | 20 | -4 | 173.4 | 123.1 | 150.2 | 179.1 | Validated preseason model | FIE diagnostic is lower; main model signals: prior receiving-yard production, recent target share, prior-season fantasy production. |
| Hunter Henry | 182.5 | 164.1 | -18.4 | -10.1% | 17 | 16 | 1 | 186.8 | 135.8 | 163.9 | 192.9 | Validated preseason model | FIE diagnostic is lower; main model signals: prior receiving-yard production, prior-season fantasy production, recent target share. |
| Brenton Strange | 192.5 | 146.7 | -45.8 | -23.8% | 18 | 21 | -3 | 169.5 | 118.7 | 146.1 | 175.3 | Validated preseason model | FIE diagnostic is lower; main model signals: prior receiving-yard production, recent target share, prior-season fantasy production. |
| T.J. Hockenson | 188.0 | 132.5 | -55.5 | -29.5% | 19 | 24 | -5 | 155.2 | 105.1 | 131.7 | 161.0 | Validated preseason model | FIE diagnostic is lower; main model signals: recent target share, prior-season fantasy production, prior reception volume. |
...
| AJ Barner | 171.4 | 130.8 | -40.6 | -23.7% | 21 | 25 | -4 | 153.6 | 103.1 | 130.4 | 158.9 | Validated preseason model | FIE diagnostic is lower; main model signals: recent target share, prior-season fantasy production, prior receiving-yard production. |
| Juwan Johnson | 168.9 | 175.3 | 6.4 | +3.8% | 22 | 12 | 10 | 198.0 | 146.9 | 174.9 | 204.0 | Validated preseason model | FIE diagnostic is higher; main model signals: prior receiving-yard production, recent target share, prior-season fantasy production. |
| Dalton Schultz | 182.9 | 185.1 | 2.2 | +1.2% | 23 | 10 | 13 | 207.9 | 156.6 | 184.6 | 213.8 | Validated preseason model | FIE diagnostic is higher; main model signals: recent target share, prior-season fantasy production, prior receiving-yard production. |
| Chig Okonkwo | 174.6 | 174.6 | 0.0 | +0.0% | 24 | 13 | 11 | — | 147.0 | 174.2 | 202.8 | Validated preseason model | No diagnostic deviation: team transfer makes prior-team role profile non-portable. |
...
| Dalton Schultz | TE | 23 | 10 | 13 | 182.9 | 185.1 | 2.2 | Validated preseason model | FIE diagnostic is higher; main model signals: recent target share, prior-season fantasy production, prior receiving-yard production. |
...
| Jordan Love | QB | 18 | 27 | -9 | 278.5 | 175.3 | -103.3 | Diagnostic model | FIE diagnostic is lower; main model signals: prior-season fantasy production, recent actual-vs-expected production gap, pfr times sacked. |
...
| Brock Wright | TE | 344 | 42 | 302 | 32.8 | 77.7 | 44.9 | Validated preseason model | FIE diagnostic is higher; main model signals: prior receiving-yard production, number of receiving competitors, recent role-change signal. |
...
| Grant Calcaterra | TE | 339 | 60 | 279 | 30.6 | 50.6 | 20.0 | Validated preseason model | FIE diagnostic is higher; main model signals: recent target share, number of receiving competitors, prior receiving-yard production. |
...
| Cameron Latu | TE | 310 | 113 | 197 | 4.0 | 4.3 | 0.3 | Validated preseason model | FIE diagnostic is higher; main model signals: recent target share, prior-season fantasy production, prior receiving-yard production. |
